"""
Training script for IgFold + ESM-2 Hybrid Model

This uses:
- IgFold BERT embeddings (512-dim) for antibodies - antibody-specific features
- ESM-2 embeddings (1280-dim) for antigens - general protein features
"""
...
def main(args):
    ...
    print(f"\n{'='*70}")
    print(f"IGFOLD + ESM-2 HYBRID TRAINING")
    print(f"{'='*70}")
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print(f"Val Recall@pKd≥9: {val_metrics['recall_pkd9']:.2f}%")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train IgFold + ESM-2 Hybrid Model')
    parser.add_argument('--data', type=str, required=True, help='Path to CSV data file')
    parser.add_argument('--output_dir', type=str, default='outputs_igfold', help='Output directory')
    parser.add_argument('--resume', type=str, default=None, help='Path to checkpoint to resume from')
    parser.add_argument('--epochs', type=int, default=50, help='Number of epochs')
    parser.add_argument('--batch_size', type=int, default=8, help='Batch size (smaller due to IgFold)')
